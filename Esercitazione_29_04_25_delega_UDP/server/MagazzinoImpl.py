...
class MagazzinoImpl(IMagazzino):
    ...
    def __init__(self,queue_size):
        ...
        self.laptop_file_name = "server/laptop.txt"
        self.smartphone_file_name = "server/smartphone.txt"
    ...
    def preleva(self, articolo):
        ...
        if articolo=="laptop":
            ...
            with self.laptop_consumer_cv:
                self.laptop_consumer_cv.wait_for(lambda:self.theres_an_item(self.laptop_queue))
            ...
            with self.smartphone_consumer_cv:
                self.smartphone_consumer_cv.wait_for(lambda:self.theres_an_item(self.smartphone_queue))
